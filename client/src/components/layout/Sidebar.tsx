        ...
        <div className="flex flex-col gap-1 pb-4">
          ...
          {filtered.map((conv) => (
            <div 
              key={conv.id}
              className={cn(
                "group rounded-lg px-2.5 py-2 text-sm transition-all hover:bg-neutral-100 cursor-pointer border border-transparent",
            ...
            >
              ...
              {editingId !== conv.id && (
                <div className="flex items-center gap-1.5 mt-1.5 ml-6">
                  <button
                    type="button"
                    className="h-6 px-2 rounded-md border border-neutral-200 bg-white flex items-center gap-1 text-xs text-neutral-600 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50 transition-colors"
                  ...
                  <button
                    type="button"
                    className="h-6 px-2 rounded-md border border-neutral-200 bg-white flex items-center gap-1 text-xs text-neutral-600 hover:text-red-600 hover:border-red-300 hover:bg-red-50 transition-colors"
